    ...
    <div>
      ...
      <div className="flex justify-center items-center text-slate-900">
        <div className="mx-4 sm:mx-8 md:mx-16 lg:mx-32 xl:mx-48 text-slate-900">
          ...
          <div className="mx-auto mt-8   rounded-lg">
            <div className="flex flex-col gap-5 sm:flex-row ">
              ...
              <div className="w-full sm:w-1/2 bg-white mx-auto border-2 border-slate-900 flex justify-center rounded-lg p-5">
                <div>
                  <div className="mb-12">
                    <h1 className="text-base font-semibold text-slate-700 text-center">
                  ...
                  <div className="mb-12">
                    ...
                    <input
                      ...
                      className="bg-[#1e394c]z-0"
                    />
                    <p className="text-center text-[#1e394c] font-bold text-lg">
                      R 
                      {formatCurrency(
              ...
              {/* Second Column */}
              <div className="w-full sm:w-1/2 hidden sm:block border-2 border-slate-900 text-slate-900 rounded-lg bg-[#e0cb70] px-5 py-3">
          ...
          <div className=" lg:hidden bg-[#e0cb70] border border-slate-900 p-6 mx-2 rounded mt-2">
